...
export default function UserManagement() {
  ...
  const createUserMutation = useMutation({
    ...
    onError: () => {
      toast('Failed to create user',{ title: 'Error', variant: 'destructive' })
    },
  })
  ...
  const updateUserMutation = useMutation({
    ...
    onError: () => {
      toast('Failed to update user',{ title: 'Error', variant: 'destructive' })
    },
  })
  ...
  const deleteUserMutation = useMutation({
    ...
    onError: () => {
      toast('Failed to delete user',{ title: 'Error', variant: 'destructive' })
    },
  })
          ...
          <form onSubmit={handleCreateUser} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <Input
                ...
                required
              />
              {newUser?.is_staff&&<Select
                value={newUser.is_staff}
                onValueChange={(value) => setNewUser({ ...newUser, is_staff: value })}
              >
                <SelectTrigger>
              ...
              <TableBody>
                {users?.map((user: User) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>{user.is_staff ? 'Admin' : 'Regular User'}</TableCell>
                    <TableCell>
                      <Dialog>
                          ...
                          {editingUser && (
                            <form onSubmit={handleUpdateUser} className="space-y-4">
                              ...
                              <Select
                                ...
                                onValueChange={(value) => setEditingUser({ ...editingUser, is_staff: value === 'true' })}
                              >
                                <SelectTrigger>
                                  <SelectValue placeholder="Role" />
                                </SelectTrigger>
