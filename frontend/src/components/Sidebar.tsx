      ...
      <div className="p-4 flex items-center justify-between">
        {!isCollapsed && (
          <div className=" w-full mr-1">
            <svg className="rounded-lg" viewBox="0 0 1200 400" version="1.1">
              <g
                id="root"
                stroke="none"
                fill="none"
              ...
              >
                <rect
                  ...
                  fill="#FA5"
                ></rect>
                <g id="group-header" transform="translate(394, 120)">
                  <rect
                    id="rectangle-header"
                    x="0"
                    y="0"
                  ...
                  <text
                    ...
                    font-size="94.75785524201898"
                    data-text-alignment="L"
                    fill="#FFFFFF"
